...
**Plans**: 4 plans
Plans:
- [ ] 06-01-PLAN.md — Wave 0: Rewrite KDA test suite (RED state — DE engine contract)
- [ ] 06-02-PLAN.md — Wave 1: Implement DE bracket engine (initState + applyThrow + getFinalResults)
...
| 6. Turnierbaum | v2.0 | 0/4 | Not started | - |
